...
//	TF1* f2 = new TF1("f2", "[0]+[1]*x", 3.5,7);
	...
	TF1* f11 = new TF1("f11", "[0]+[1]*x", 0,2);
	TF1* f22 = new TF1("f22", "[0]+[1]*x", 3.5,7);
...
//			cout<<volt[counter]<<"\t"<<current[counter]<<endl;
		...
		gr1->SetLineWidth(2);
		gr1->Draw("ACP");
		f11->SetParameter(0,c_1);
		f22->SetParameter(0,c_2);
		f11->SetParameter(1,m_1);
		f22->SetParameter(1,m_2);
		f11->SetLineColor(kYellow);
		f11->Draw("Same");
